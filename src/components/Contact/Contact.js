        ...
        <div id='contact' className='contactContainer'>
            ...
            <div className='contactList'>
                <div className='linkedin'>
                    <img src={process.env.PUBLIC_URL + '/icons/linkedin.jpg'} alt='linkedin'></img>
                ...
                <div className='github'>
                    <img src={process.env.PUBLIC_URL + '/icons/github.png'} alt='github'></img>
                    <a href='https://github.com/Himanshu-1997' target='_blank' rel="noopener noreferrer">https://github.com/Himanshu-1997</a>
                </div>
                <div className='facebook'>
                    <img src={process.env.PUBLIC_URL + '/icons/fb.jpg'} alt='fb'></img>
                ...
                <div className='gmail'>
                    <img src={process.env.PUBLIC_URL + '/icons/gmail.png'} alt='gmail'></img>
